...
var $author$project$IncrementalPiano$BeforeGame = {$: 'BeforeGame'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$IncrementalPiano$init = function (_v0) {
	return _Utils_Tuple2(
		{bestScore: 0, level: 1, mode: $author$project$IncrementalPiano$BeforeGame, note: 44, rangeStart: 32},
		$elm$core$Platform$Cmd$none);
};
var $author$project$IncrementalPiano$KeyDown = function (a) {
	return {$: 'KeyDown', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$IncrementalPiano$Enter = {$: 'Enter'};
var $author$project$IncrementalPiano$Left = {$: 'Left'};
var $author$project$IncrementalPiano$Other = {$: 'Other'};
var $author$project$IncrementalPiano$Right = {$: 'Right'};
var $author$project$IncrementalPiano$toKeyInput = function (s) {
	switch (s) {
		case 'ArrowLeft':
			return $author$project$IncrementalPiano$Left;
		case 'ArrowRight':
			return $author$project$IncrementalPiano$Right;
		case 'Enter':
			return $author$project$IncrementalPiano$Enter;
		default:
			return $author$project$IncrementalPiano$Other;
	}
};
var $author$project$IncrementalPiano$keyDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$IncrementalPiano$toKeyInput,
...
var $author$project$IncrementalPiano$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onKeyDown(
				A2($elm$json$Json$Decode$map, $author$project$IncrementalPiano$KeyDown, $author$project$IncrementalPiano$keyDecoder))
			]));
};
var $author$project$IncrementalPiano$GameOver = {$: 'GameOver'};
var $author$project$IncrementalPiano$NextNote = function (a) {
	return {$: 'NextNote', a: a};
};
var $author$project$IncrementalPiano$Play = {$: 'Play'};
var $author$project$IncrementalPiano$Ready = function (a) {
	return {$: 'Ready', a: a};
};
var $author$project$IncrementalPiano$Submit = {$: 'Submit'};
var $author$project$IncrementalPiano$Waiting = {$: 'Waiting'};
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$IncrementalPiano$clamp = F3(
	function (low, high, x) {
		return A2(
			$elm$core$Basics$min,
			high,
...
var $author$project$IncrementalPiano$noteToFrequency = function (i) {
	var n = i - 48;
	var a = A2($elm$core$Basics$pow, 2, 1 / 12);
	return 440.0 * A2($elm$core$Basics$pow, a, n);
};
var $author$project$IncrementalPiano$initialRange = 36;
var $author$project$IncrementalPiano$selectionSize = function (level) {
	return ($author$project$IncrementalPiano$initialRange - level) + 1;
};
var $author$project$IncrementalPiano$tone = _Platform_outgoingPort('tone', $elm$core$Basics$identity);
var $author$project$IncrementalPiano$update = F2(
	function (msg, model) {
		update:
		while (true) {
			switch (msg.$) {
				case 'Play':
					...
					return _Utils_Tuple2(
						...
						A2(
							$elm$random$Random$generate,
							$author$project$IncrementalPiano$NextNote,
				...
				case 'NextNote':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{mode: $author$project$IncrementalPiano$Waiting, note: i}),
						$author$project$IncrementalPiano$tone(
							$elm$json$Json$Encode$float(
								$author$project$IncrementalPiano$noteToFrequency(i))));
				case 'Submit':
					var upper = model.rangeStart + $author$project$IncrementalPiano$selectionSize(model.level);
					...
					var m = ((_Utils_cmp(lower, model.note) < 1) && (_Utils_cmp(model.note, upper) < 1)) ? _Utils_update(
						model,
						{
							...
							level: model.level + 1,
							mode: $author$project$IncrementalPiano$Ready(true)
						}) : ((model.level === 1) ? _Utils_update(
						model,
						{
							bestScore: A2($elm$core$Basics$max, model.bestScore, model.level),
							mode: $author$project$IncrementalPiano$GameOver
						}) : _Utils_update(
						model,
						{
							level: model.level - 1,
							mode: $author$project$IncrementalPiano$Ready(false)
						}));
					return _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
				case 'KeyDown':
					var k = msg.a;
					if (_Utils_eq(k, $author$project$IncrementalPiano$Enter)) {
						if (_Utils_eq(model.mode, $author$project$IncrementalPiano$Waiting)) {
							var $temp$msg = $author$project$IncrementalPiano$Submit,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						} else {
							var $temp$msg = $author$project$IncrementalPiano$Play,
								$temp$model = model;
							msg = $temp$msg;
							model = $temp$model;
							continue update;
						...
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									rangeStart: A3(
										$author$project$IncrementalPiano$clamp,
										0,
										87 - $author$project$IncrementalPiano$selectionSize(model.level),
										desiredRangeStart)
								}),
							$elm$core$Platform$Cmd$none);
					}
				default:
					var id = msg.a;
					var _v3 = $elm$core$String$toInt(id);
					if (_v3.$ === 'Nothing') {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						var key = _v3.a;
						var w = $author$project$IncrementalPiano$selectionSize(model.level);
						var rangeStart = key - ((w / 2) | 0);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									rangeStart: A3($author$project$IncrementalPiano$clamp, 0, 87 - w, rangeStart)
								}),
							$elm$core$Platform$Cmd$none);
					}
			}
...
var $author$project$IncrementalPiano$blackNotes = _List_fromArray(
	[1, 4, 6, 9, 11]);
...
var $author$project$IncrementalPiano$isBlackKey = function (key) {
	return A2(
		$elm$core$List$member,
		A2($elm$core$Basics$modBy, 12, key),
		$author$project$IncrementalPiano$blackNotes);
};
...
var $author$project$IncrementalPiano$blackOffset = function (scaleNote) {
	switch (scaleNote) {
		case 1:
			return 0;
		case 4:
...
var $author$project$IncrementalPiano$ClickedNote = function (a) {
	return {$: 'ClickedNote', a: a};
};
...
var $author$project$IncrementalPiano$noteClick = function () {
	var decoder = $elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2(
				$elm$json$Json$Decode$map,
				$author$project$IncrementalPiano$ClickedNote,
				A2(
...
var $author$project$IncrementalPiano$noteColour = F3(
	function (model, key, isBlack) {
		var upper = ((model.rangeStart + $author$project$IncrementalPiano$initialRange) + 1) - model.level;
		var lower = model.rangeStart;
		var inSelection = (!_Utils_eq(model.mode, $author$project$IncrementalPiano$BeforeGame)) && ((_Utils_cmp(lower, key) < 1) && (_Utils_cmp(key, upper) < 1));
		return (inSelection && isBlack) ? 'teal' : (inSelection ? 'turquoise' : (((_Utils_eq(model.mode, $author$project$IncrementalPiano$GameOver) || _Utils_eq(
			model.mode,
			$author$project$IncrementalPiano$Ready(false))) && ((_Utils_cmp(model.note, lower) < 0) && (_Utils_cmp(key, lower) < 0))) ? 'red' : (((_Utils_eq(model.mode, $author$project$IncrementalPiano$GameOver) || _Utils_eq(
			model.mode,
			$author$project$IncrementalPiano$Ready(false))) && ((_Utils_cmp(model.note, upper) > 0) && (_Utils_cmp(key, upper) > 0))) ? 'red' : (isBlack ? 'black' : ((key === 39) ? 'green' : 'white')))));
	});
...
var $author$project$IncrementalPiano$showKey = F3(
	function (model, isBlack, _v0) {
		var i = _v0.a;
		var key = _v0.b;
		var status = A3($author$project$IncrementalPiano$noteColour, model, key, isBlack);
		var scaleNote = A2($elm$core$Basics$modBy, 12, key);
		var keyWidth = 16;
		var xOffset = isBlack ? (((((((key / 12) | 0) * 7) + $author$project$IncrementalPiano$blackOffset(scaleNote)) * keyWidth) + ((keyWidth / 2) | 0)) + 2) : (i * keyWidth);
		var keyHeight = isBlack ? '48' : '72';
		var drawWidth = keyWidth - (isBlack ? 4 : 0);
		return A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
					...
					$elm$core$String$fromInt(drawWidth)),
					$elm$svg$Svg$Attributes$height(keyHeight),
					$elm$svg$Svg$Attributes$style('stroke:black;fill:' + status),
					$elm$svg$Svg$Attributes$id(
					$elm$core$String$fromInt(key)),
					$author$project$IncrementalPiano$noteClick
				]),
			_List_Nil);
	});
var $elm$svg$Svg$svg = $elm$svg$Svg$trustedNode('svg');
var $elm$svg$Svg$Attributes$viewBox = _VirtualDom_attribute('viewBox');
var $author$project$IncrementalPiano$showPiano = function (model) {
	var pianoRange = A2($elm$core$List$range, 0, 87);
	var whiteKeys = A2(
		$elm$core$List$map,
		A2($author$project$IncrementalPiano$showKey, model, false),
		A2(
			$elm$core$List$indexedMap,
			$elm$core$Tuple$pair,
			A2(
				$elm$core$List$filter,
				A2($elm$core$Basics$composeL, $elm$core$Basics$not, $author$project$IncrementalPiano$isBlackKey),
				pianoRange)));
	var blackKeys = A2(
		$elm$core$List$map,
		A2($author$project$IncrementalPiano$showKey, model, true),
		A2(
			$elm$core$List$indexedMap,
			$elm$core$Tuple$pair,
			A2($elm$core$List$filter, $author$project$IncrementalPiano$isBlackKey, pianoRange)));
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$width('860'),
						$elm$svg$Svg$Attributes$height('200'),
						$elm$svg$Svg$Attributes$viewBox('0 0 860 200')
					]),
				_Utils_ap(whiteKeys, blackKeys))
			]));
};
...
var $author$project$IncrementalPiano$showStatus = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('https://github.com/destynova/pitcher')
													]),
												_List_fromArray(
													[
														A2(
...
var $author$project$IncrementalPiano$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
										...
										A3(
																	...
																	[
																		...
																		_List_fromArray(
																			[
																				...
																				_Utils_eq(model.mode, $author$project$IncrementalPiano$Waiting)),
																				$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$IncrementalPiano$Play)
																			]),
																		_List_fromArray(
																			[
																	...
																	[
																		...
																		_List_fromArray(
																			[
																				...
																				$rundis$elm_bootstrap$Bootstrap$Button$disabled(
																				!_Utils_eq(model.mode, $author$project$IncrementalPiano$Waiting)),
																				$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$IncrementalPiano$Submit)
																			]),
																		_List_fromArray(
																			[
											...
											A3(
												...
												_List_fromArray(
													[
														$rundis$elm_bootstrap$Bootstrap$Card$Block$custom(
														$author$project$IncrementalPiano$showPiano(model))
													]),
												A3(
													$rundis$elm_bootstrap$Bootstrap$Card$block,
													_List_Nil,
													_List_fromArray(
														[
															$rundis$elm_bootstrap$Bootstrap$Card$Block$custom(
															$author$project$IncrementalPiano$showStatus(model))
														]),
...
var $author$project$IncrementalPiano$main = $elm$browser$Browser$element(
	{init: $author$project$IncrementalPiano$init, subscriptions: $author$project$IncrementalPiano$subscriptions, update: $author$project$IncrementalPiano$update, view: $author$project$IncrementalPiano$view});
_Platform_export({'IncrementalPiano':{'init':$author$project$IncrementalPiano$main(
